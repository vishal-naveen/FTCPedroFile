...
//@Autonomous(name = "dodsonWay5Specimen", group = "Auto Testing")
public class dodsonWay5Specimen extends OpMode {
    ...
    /** Start Pose of our robot */
    private final Pose startPose = new Pose(9.4, 62.8, Math.toRadians(0));

    /** Scoring Pose of our robot */

    private final Pose preload = new Pose(36.5, 72.96, Math.toRadians(0));

    private final Pose scoreBlock = new Pose(36.5, 72.96, Math.toRadians(0));
    private final Pose blueLineUp = new Pose(54.9, 34.56, Math.toRadians(0));
    private final Pose pushBlock1 = new Pose(10.5, 26.7, Math.toRadians(0));
    private final Pose pushBlock2 = new Pose(11, 13.9, Math.toRadians(0));

    private final Pose pushBlock3 = new Pose(11.1, 10.1, Math.toRadians(0));


    private final Pose pickUp = new Pose(10.5, 26.7, Math.toRadians(0));
    ...
    private Path scorePreload, pickUpToScore1, scoreToPickUp, pickUpToScore2, pickUpToScore3, pickUpToScore4, scoreToBlock2, scoreToBlock3, park;
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 4:
                ...
                break;
            case 5:
                follower.followPath(pickUpToScore1);
                setPathState(6);
                break;
            case 6:
                clawClose();
            ...
            case 10:
                ...
                break;
            case 11:
                follower.followPath(pickUpToScore2);
                setPathState(12);
                break;
            case 12:
                clawClose();
            ...
            case 13:
                ...
                break;
            case 14:
                follower.followPath(scoreToBlock2);
                setPathState(15);
                break;
            case 15:
                pickUpFull();
                ...
                break;
            case 16:
                follower.followPath(pickUpToScore3);
                setPathState(17);
                break;
            case 17:
                clawClose();
            ...
            case 18:
                ...
                break;
            case 19:
                follower.followPath(scoreToBlock3);
                setPathState(20);
                break;
            case 20:
                pickUpFull();
                ...
                break;
            case 21:
                follower.followPath(pickUpToScore4);
                setPathState(22);
                break;
            case 22:
                clawClose();
