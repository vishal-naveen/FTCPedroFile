...
public class ExampleBucketAuto extends OpMode {
    ...
    private final Pose scorePose = new Pose(31, 85, Math.toRadians(0));

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose pickup1Pose = new Pose(58.5, 46, Math.toRadians(0));

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(10, 35, Math.toRadians(0));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(10, 24.5, Math.toRadians(0));

    /** Park Pose for our robot */
    private final Pose parkPose = new Pose(10, 16, Math.toRadians(0));

    /** Park Control Pose for our robot */
    private final Pose parkControlPose = new Pose(10, 16, Math.toRadians(0));
