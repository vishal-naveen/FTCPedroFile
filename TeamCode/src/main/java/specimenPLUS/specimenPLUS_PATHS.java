...
//    private static final Pose preloadToBackPos = new Pose(23.3, 68.1, Math.toRadians(0));
    ...
    private static final Pose pushBlock2 = new Pose(13.5, 26, Math.toRadians(-5));
    private static final Pose pushBlock3 = new Pose(10.3, 13, Math.toRadians(-5));
    ...
    private static final Pose pickUpAlt = new Pose(12.5, 25.9, Math.toRadians(0));
...
//        preloadToBlueLineUp.setLinearHeadingInterpolation(preloadToBackPos.getHeading(), blueLineUp.getHeading());
        ...
        blueLineDirect = new Path(new BezierCurve(new Point(startPose), new Point(27, 76.8), new Point(4.7, 30.5), new Point(blueLineUp)));
        ...
        pushBlock1ToPushBlock2 = new Path(new BezierCurve(new Point(pushBlock1), new Point(90, 12), new Point(pushBlock2)));
        pushBlock1ToPushBlock2.setLinearHeadingInterpolation(pushBlock1.getHeading(), pushBlock2.getHeading());

        pushBlock2ToPushBlock3 = new Path(new BezierCurve(new Point(pushBlock2), new Point(90, 9.2), new Point(pushBlock3)));
...
//        pushToScoreBefore1.setLinearHeadingInterpolation(pushBlock3.getHeading(), scoreBlockBefore1.getHeading());
        ...
        score1ToPickUp = new Path(new BezierCurve(new Point(scoreBlock1), new Point(26.1, 69.8), new Point(pickUpAlt)));
        ...
        score2ToPickUp = new Path(new BezierCurve(new Point(scoreBlock2), new Point(26.1, 69.8), new Point(pickUpAlt)));
        ...
        score3ToPickUp = new Path(new BezierCurve(new Point(scoreBlock3), new Point(26.1, 69.8), new Point(pickUpAlt)));
        ...
        scoreBefore4ToScore4 = new Path(new BezierCurve(new Point(scoreBlockBefore4), new Point(scoreBlock4)));
        scoreBefore4ToScore4.setLinearHeadingInterpolation(scoreBlockBefore3.getHeading(), scoreBlock3.getHeading());

        score4ToPickUp = new Path(new BezierCurve(new Point(scoreBlock4), new Point(26.1, 69.8), new Point(pickUpAlt)));
