...
public class specimenPLUS_PATHS {
    ...
    // Poses
    private static final Pose startPose = new Pose(9.4, 81.1, Math.toRadians(0));

    // Score poses updated with before positions
    private static final Pose scoreBlock1 = new Pose(41.5, 77.2, Math.toRadians(0));
    private static final Pose scoreBlockBefore1 = new Pose(36, 77.2, Math.toRadians(0));
    private static final Pose scoreBlock2 = new Pose(41.5, 76.8, Math.toRadians(0));
    private static final Pose scoreBlockBefore2 = new Pose(37, 76.8, Math.toRadians(0));
    private static final Pose scoreBlock3 = new Pose(41.5, 76.4, Math.toRadians(0));
    private static final Pose scoreBlockBefore3 = new Pose(36, 76.4, Math.toRadians(0));

    private static final Pose scoreBlock4 = new Pose(41.5, 76, Math.toRadians(0));
    private static final Pose scoreBlockBefore4 = new Pose(36, 76, Math.toRadians(0));

    private static final Pose scoreBlock5 = new Pose(41.5, 75.6, Math.toRadians(0));
    ...
    private static final Pose pushBlock3 = new Pose(11.3, 16.4, Math.toRadians(0));

    private static final Pose pushBlock3Pick = new Pose(16.1, 35, Math.toRadians(0));
    private static final Pose pickUp = new Pose(14.5, 35, Math.toRadians(0));

    private static final Pose pickUpAlt = new Pose(13.3, 35, Math.toRadians(0));
    ...
    public static PathChain paths() {
        ...
        blueLineDirect = new Path(new BezierCurve(new Point(startPose), new Point(3.8, 36.5), new Point(blueLineUp)));
