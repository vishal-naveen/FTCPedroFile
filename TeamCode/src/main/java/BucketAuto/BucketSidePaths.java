...
public class BucketSidePaths {
    ...
    private static final Pose pickUpBlock1Pos = new Pose(25, 123.5, Math.toRadians(175));
    private static final Pose pickUpBlock2Pos = new Pose(25, 133.3, Math.toRadians(175));
