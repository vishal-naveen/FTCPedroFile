...
public class positions_motor {
    ...
    public static final int VIPER_HIGHBAR = 775;

    public static final int VIPER_AUTO_END = 1500;
    public static final int VIPER_HIGHBAR2 = 1200;
    public static final int VIPER_LOWBASKET = 700;
    public static final int VIPER_HIGHBASKET = 3700
            ;
    ...
    public static final double NIntakeArmExtendedFull = 0.9;
    public static final double NIntakeArmExtendedThird = 0.4;
    public static final double NIntakeArmExtendedQuater = 0.2;
    public static final double NIntakeArmExtendedBack = 0;

    public static final double NIntakeWristPickUp = 1;

    public static final double NIntakeWristPickUpBefore = 0.7;
    public static final double NIntakeWristTransfer = 0;
    public static final double NIntakeWristPivotHorizontal = 0;

    public static final double NIntakeWristPivotVertical = 0.35;
    public static final double NIntakeClawOpen = 0.4;
    public static final double NIntakeClawClose = 0.7;


    //OUTTAKEEE
    public static final double OuttakeArmTransfer = 0.8;

    public static final double OuttakeArmPedroAuto = 0.5;
    public static final double OuttakeArmBucket = 0.4;
    public static final double OuttakeArmHighBar = 0.05;
    ...
    public static final double OuttakeWristTransfer = 0.2;
    ...
    //0.75 is straight
    //0.6 is sticking up
    public static final double OuttakeWristPickUpSpecimen = 0.65;
    ...
    public static final double OuttakeWristPivotHorizontal = 0;

    public static final double OuttakeWristPivotVertical = 0.35;

    public static final double OuttakeWristPivotSpecimenPickUp = 0;

    public static final double OuttakeWristPivotHighBar = 0.65;

    public static final double OuttakeClawOpen = 0.1;
    public static final double OuttakeClawClose = 0.9;
